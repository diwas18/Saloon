    ...
    <body class="font-sans antialiased">
        ...
        <div class="flex">
            <nav class="w-56 h-screen shadow-lg bg-gray-700">
                <!-- Sunshine Saloon Logo -->
                <a href="{{ route('dashboard') }}">
                    <img src="{{ asset('storage/images/logo.webp') }}" alt="Sunshine Saloon Logo" class="w-32 mx-auto mt-4 filter brightness-0 invert">
                </a>
                ...
                <ul class="mt-8">
                    ...
                    <li>
                        <form action="{{route('logout')}}" method="POST">
                            @csrf
                            <button type="submit" class="block hover:bg-blue-200 p-4 rounded-lg font-bold text-xl w-full text-left">Log Out</button>
                        </form>
                    </li>
                </ul>
            </nav>
